...
class ContractFile(db.Model):
    ...
    - kind='payment_order' -> платёжки (PDF, много)
    ...
    kind = db.Column(db.String(50), nullable=False, default="attachment")  # contract / addendum / payment_order / power_of_attorney / attachment
