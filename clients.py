...
from models import db, Client, Contract, Balance, BalanceChangeRequest, Talon, ContractFile, TalonRedemption
...
@clients_bp.post("/balance-requests/<int:request_id>/approve", endpoint="approve_balance_request")
@login_required
...
@clients_bp.post("/balance-requests/<int:request_id>/reject", endpoint="reject_balance_request")
@login_required
...
def client_reports(client_id):
    ...
    return render_template(
        ...
        client_rows=summary_by_client,
        addendum_summary=addendum_summary,
        addendum_rows=addendum_summary,
